...
<body>
  ...
  <div class="d-lg-flex half">
    ...
    <div class="bg order-1 order-md-2 transboxRegister" style="background-image:url('/BDM/public/img/register.jpg')">
    </div>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center ">
          <div class="col-md-12">
            ...
            <form action="/BDM/php/APIRegistro.php" method="POST" id="formRegistro" name="formRegistro"
              ...
              <div class="text-center">
                  ...
                  <div class="col align-self-start">
                    ...
                    <div class="radio-buttons-container">
                      <div class="radio-button">
                        <input name="tipo" id="radioComprador" class="radio-button__input" type="radio"
                          value="Comprador">
                ...
                <div class="row">
                  ...
                  <div class="col">
                    ...
                    <div class="radio-buttons-container">
                      <div class="radio-button">
                        <input name="genero" id="radioFemenino" class="radio-button__input" type="radio"
                          value="Femenino">
                      ...
                      <div class="radio-button">
                        <input name="genero" id="radioMasculino" class="radio-button__input" type="radio"
                          value="Masculino">
                      ...
                      <div class="radio-button">
                        <input name="genero" id="radioIndefinido" class="radio-button__input" type="radio"
                          value="Indefinido">
