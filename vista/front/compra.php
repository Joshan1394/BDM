        ...
        <div class=" card text-center" style="margin-left:10%; margin-right:10%">
            <div class="row">
                <div class="col">
                    ...
                    <br>
                    <div class="card-footer text-muted" style="background-color:rgb(118, 131, 136); margin-left:5%; margin-top:2%">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6 col-md-6 pull-right">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="last name" placeholder="Ingrese su apellido" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xs-12 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" name="Number" placeholder="0000 0000 0000" required="">
                                                            <span class="input-group-addon" style="margin-top:1%; margin-left:1%"><i data-feather="credit-card"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
